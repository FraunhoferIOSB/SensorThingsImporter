...
/**
 * Converts Records into Observations using a Groovy script.
 */
public class RecordConverterGroovy implements RecordConverter {
    ...
    @EditorString.EdOptsString(lines = 20,
            dflt = """
                    Class Script implements RecordConverter {
                      public List<Observation> convert(Record record) throws ImportException {
                        // Your code here
                      }
                    }""")
